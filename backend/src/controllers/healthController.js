...
export async function getProviderStatus(_req, res) {
  ...
  return res.status(200).json({
    ...
    speech_recognition: providers.transcription?.routing === 'language_aware' ? { routing: 'language_aware', providers: {
    ...
    speaker_verification: { provider: providers.speaker?.provider || 'ecapa_tdnn', local: true,
